                    ...
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {[
                                ...
                                { icon: 'build', label: 'Skill Reach', desc: 'Equipping youth with essential digital, technical, and foreign language skills. We provide personalized career guidance to enhance their employability in the modern workforce.', to: '/skill-reach', color: 'bg-primary text-white', image: '/Images/skill_reach.jpeg', points: ['Digital & Tech Skills', 'Career Guidance', 'Defence Sector'] },
