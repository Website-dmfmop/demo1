                    ...
                    <div className="max-w-7xl mx-auto">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-on-surface-variant max-w-3xl mx-auto leading-relaxed">
                                {language === 'hi' ? 'डॉ. ज्ञानेश्वर मुलय फाउंडेशन में, हम मानते हैं कि हर व्यक्ति गरिमा, सम्मान और भावनात्मक सुरक्षा के साथ बूढ़ा होने का हकदार है। हमारी शेल्टर होम पहल वरिष्ठ नागरिकों के लिए एक सुरक्षित, पोषणकारी और समावेशी वातावरण प्रदान करने का एक हार्दिक प्रयास है।' : 'At the Dr. Dnyaneshwar Mulay Foundation, we believe that every individual deserves to age with dignity, respect, and emotional security. Our Shelter Home initiative is a heartfelt effort to provide a safe, nurturing, and inclusive environment for senior citizens who seek care, companionship, and a sense of belonging.'}
                            </p>
                        </div>
